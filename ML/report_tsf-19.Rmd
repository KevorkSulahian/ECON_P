...
year_2019_predict_ARIMA <- (as.data.frame(ts_arima_forecast))[1][c(1:6),]
...
year_2019_predict_ARIMA <- (as.data.frame(ts_arima_forecast))[1][c(1:6),]
sum_year_2019 = sum(c(year_2019,year_2019_predict_ARIMA))
growth_ARIMA2 <- growth(sum_year_2019, sum(year_2018))
growth_ARIMA2 
...
rownames(df) = "nov-19"
writexl::write_xlsx(df,"total-industry-19.xlsx")
```